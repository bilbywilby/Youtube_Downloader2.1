...
# (Duplicate setup_logging definition removed)
...
# (Removed duplicate FileManager class definition to resolve class name conflict)
...
class SystemManager:
    ...
    def get_system_info() -> Dict[str, Any]:
        ...
        return {
            ...
            "disk_usage": {
                str(DOWNLOADS_ROOT): psutil.disk_usage(str(DOWNLOADS_ROOT))._asdict()
            },
        }
    ...
    def add_to_queue(self, url: str, options: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if not FileManager.check_disk_space(
                self.config.config.download_dir, self.config.config.min_disk_space
            ):
    ...
    def _prepare_download_options(self, download_item: DownloadItem) -> Dict[str, Any]:
        ...
        opts = {
            "format": self._get_format_string(
                download_item.quality, download_item.format
            ),
    ...
    def _create_window(self) -> sg.Window:
        ...
        queue_section = [
            [sg.Frame('Download Queue', [
                ...
                [sg.Button(' Start Download', key='-START-', size=(15, 1)),
                 sg.Button(' Cancel', key='-CANCEL-', size=(15, 1)),
                 sg.Button(' Settings', key='-SETTINGS-', size=(15, 1))],
                [sg.Button(' Open Folder', key='-OPEN_FOLDER-', size=(15, 1))]
            ])],
        ]
            ...
            [
                sg.Frame(
                    ...
                    [
                        ...
                        [
                            sg.Input(
                                default_text=self.config_manager.config.download_dir,
                                key="-DIR-",
                                size=(50, 1),
                                tooltip=tooltips["-DIR-"],
                            ),
                            sg.FolderBrowse(),
                        ],
                        [
            ...
            [
                sg.Frame(
                    ...
                    [
                        [
                            sg.ProgressBar(
                                100, orientation="h", size=(50, 20), key="-PROGRESS-"
                            )
                        ],
                        [
                            sg.Text("Status:", font=("Helvetica", 10)),
                ...
                sg.Frame(
                    ...
                    [
                        ...
                        [
                            ...
                            sg.Button(
                                "🗑 Clear History", key="-CLEAR_HISTORY-", size=(15, 1)
                            ),
                        ],
                    ],
                )
